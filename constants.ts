...
export const MOCK_PROPERTIES: Property[] = [
  { id: 1, title: 'Villa Luxueuse Cocody', price: 150000000, location: 'Abidjan, Cocody', typeId: 'pt1', status: 'active', ownerId: '2', imageUrl: 'https://picsum.photos/400/300', createdAt: '2023-09-01' },
  { id: 2, title: 'Appartement F4 Marcory', price: 500000, location: 'Abidjan, Marcory', typeId: 'pt2', status: 'rented', ownerId: '2', imageUrl: 'https://picsum.photos/401/300', createdAt: '2023-10-15' },
  { id: 3, title: 'Terrain Bingerville', price: 25000000, location: 'Abidjan, Bingerville', typeId: 'pt3', status: 'pending', ownerId: '1', imageUrl: 'https://picsum.photos/402/300', createdAt: '2023-11-01' },
];

export const MOCK_VISITS: VisitRequest[] = [
  { id: 1, propertyId: 'p1', clientId: '3', ownerId: '2', date: '2023-11-20T14:00:00', status: 'pending', message: 'Je suis très intéressé.' },
  { id: 2, propertyId: 'p2', clientId: '4', ownerId: '2', date: '2023-11-22T10:00:00', status: 'confirmed' },
  { id: 3, propertyId: 'p1', clientId: '4', ownerId: '2', date: '2023-11-18T09:00:00', status: 'rejected' },
];

export const MOCK_ALERTS: Alert[] = [
  { id: 1, userId: '3', criteria: 'Appartement 3 pièces, Zone 4, Max 600k', createdAt: '2023-11-10', status: 'new' },
  { id: 2, userId: '4', criteria: 'Villa avec piscine, Riviera', createdAt: '2023-11-05', status: 'responded' },
];
