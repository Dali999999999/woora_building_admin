...
const Dashboard: React.FC = () => {
  ...
  const revenueData = Array.isArray(stats.revenue_chart) ? stats.revenue_chart : [];
  const userGrowthData = Array.isArray(stats.user_growth_chart) ? stats.user_growth_chart : [];
    ...
    <div className="space-y-6 animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-100">
          ...
          <div className="h-72 w-full min-h-[300px] min-w-[300px]">
